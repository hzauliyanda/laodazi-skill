...
/**
 * Copy HTML content to the system clipboard from a file
 */
...
/**
 * Copy HTML content to the system clipboard from a string
 */
export async function copyHtmlStringToClipboard(html: string): Promise<void> {
  await withTempDir('copy-to-clipboard-', async (tempDir) => {
