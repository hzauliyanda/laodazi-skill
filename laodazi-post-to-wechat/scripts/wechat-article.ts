...
export async function postArticle(options: ArticleOptions): Promise<void> {
  ...
  try {
    ...
    // First, click on editor and paste content BEFORE filling title
    // This avoids clearing editor content when title is set
    ...
    // Fill title and author AFTER content is pasted to avoid editor clearing
    if (effectiveTitle) {
